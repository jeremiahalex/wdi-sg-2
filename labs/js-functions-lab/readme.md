...
6. Define a function `reverseString` that computes the reversal of a string. For example, reverseString("jag testar") should return the string "ratset gaj". _Hint you can treat strings like an array to access the characters at a specific position using [index]_
...
1. Write a function that takes a string as argument and returns an object where:
